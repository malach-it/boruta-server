defmodule BorutaAdminWeb.OrganizationController do
  ...
  #     {:error,
  #      Ecto.Changeset.change(%Organization{}) |> Ecto.Changeset.add_error(:backend, "does not exist")}

  #   error in LdapError ->
  #     {:error,
  #      Ecto.Changeset.change(%Organization{}) |> Ecto.Changeset.add_error(:backend, error.message)}
  # end
  ...
  #     _ ->
  #       {:error, Ecto.Changeset.change(%Organization{}) |> Ecto.Changeset.add_error(:file, "is invalid")}
  #   end
  # rescue
  #   _e in Ecto.NoResultsError ->
  #     {:error,
  ...
  #        %Organization{} = user <- Admin.get_user(id),
  #        # TODO update user email and password
  #        {:ok, %Organization{} = user} <- Admin.update_user(user, user_params) do
  #     render(conn, "show.json", user: user)
  #   else
  #     nil -> {:error, :not_found}
  #     error -> error
  ...
  #   else
  #     {:error, "" <> reason} ->
  #       {:error, Ecto.Changeset.change(%Organization{}) |> Ecto.Changeset.add_error(:backend, reason)}
