...
const assign = {
  ...
  ldap_host: function ({ ldap_host }) { this.ldap_host = ldap_host },
  ldap_user_rdn_attribute: function ({ ldap_user_rdn_attribute }) { this.ldap_user_rdn_attribute = ldap_user_rdn_attribute },
  ldap_base_dn: function ({ ldap_base_dn }) { this.ldap_base_dn = ldap_base_dn },
  ldap_ou: function ({ ldap_ou }) { this.ldap_ou = ldap_ou },
  ldap_master_dn: function ({ ldap_master_dn }) { this.ldap_master_dn = ldap_master_dn },
  ldap_master_password: function ({ ldap_master_password }) { this.ldap_master_password = ldap_master_password },
