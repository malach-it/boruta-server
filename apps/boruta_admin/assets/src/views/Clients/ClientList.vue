<template>
  <div class="client-list">
    ...
    <router-link :to="{ name: 'new-client' }" class="ui primary main create button">Add a client</router-link>
    <div class="container">
      <div class="ui error message" v-if="error">
        {{ error }}
      </div>
      <div class="ui info message">
        Clients are here relying parties as defined in <a target="_blank" href="https://datatracker.ietf.org/doc/html/rfc6749#section-1.1">OAuth 2.0 RFC</a>. They are the applications that require a privileged access to a HTTP service secured by the Boruta authorization server.
      </div>
