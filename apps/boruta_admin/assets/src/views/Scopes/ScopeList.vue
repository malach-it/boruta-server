  ...
  <div id="scope-list">
    ...
    <div class="container">
      ...
      <div class="ui info message">
        Scopes are here the ones that are to be requested by the client. They are to be public, accessible to everyone, or private, granted only having a privileged user or client.
      </div>
