...
export default {
  ...
  computed: {
    ...
    preauthorizeUrl () {
     return window.env.BORUTA_OAUTH_BASE_URL +
      `/oauth/authorize?client_id=00000000-0000-0000-0000-000000000001&redirect_uri=${this.presentationRedirectUri}&response_type=id_token urn%3Aietf%3Aparams%3Aoauth%3Aresponse-type%3Apre-authorized_code&client_metadata={}&state=qrm0c4xm`
    },
    presentationPreauthorizeUrl () {
     return window.env.BORUTA_OAUTH_BASE_URL +
      `/oauth/authorize?client_id=00000000-0000-0000-0000-000000000001&redirect_uri=${this.presentationRedirectUri}&response_type=vp_token urn%3Aietf%3Aparams%3Aoauth%3Aresponse-type%3Apre-authorized_code&client_metadata={}&state=qrm0c4xm&scope=BorutaCredentialJwtVc`
    }
  },
  methods: {
    setRequestedScope () {
